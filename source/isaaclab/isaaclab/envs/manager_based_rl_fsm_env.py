...
from isaaclab_tasks.manager_based.manipulation.inair.mdp.rewards import object_vel_penalty, palm_drop_penalty, above_palm, success_bonus, track_delta_orientation_l2, track_orientation_inv_l2, track_object_l1, object_height_penalty
...
class ManagerBasedRLFSMEnv(ManagerBasedRLEnv):
    ...
    def log_info(self, info):
        ...
        body_undesired = undesired_contacts(self, threshold=1e-5, sensor_cfg=SceneEntityCfg(name="link6_sensor"))
        ...
        info["episode"] = {
            ...
            "INIT/track_object_l1": ((self.fsm_state == FSMState.INIT) * (-FSMRewardScales_0.track_object_l1 * track_object)).detach(),
            ...
            "INIT/reward_case_0": (
                ...
                * (
                    ...
                    -FSMRewardScales_0.track_object_l1 * track_object
            ...
            "BEFORE_THROW/track_object_l1": ((self.fsm_state == FSMState.BEFORE_THROW) * (-FSMRewardScales_1.track_object_l1 * track_object)).detach(),
            ...
            "BEFORE_THROW/reward_case_1": (
                ...
                * (
                    ...
                    -FSMRewardScales_1.track_object_l1 * track_object
            ...
            "IN_AIR/track_object_l1": ((self.fsm_state == FSMState.IN_AIR) * (-FSMRewardScales_2.track_object_l1 * track_object)).detach(),
            ...
            "IN_AIR/reward_case_2": (
                ...
                * (
                    ...
                    -FSMRewardScales_2.track_object_l1 * track_object
            ...
            "BACK_IN_HAND/track_object_l1": ((self.fsm_state == FSMState.BACK_IN_HAND) * (-FSMRewardScales_3.track_object_l1 * track_object)).detach(),
            ...
            "BACK_IN_HAND/reward_case_3": (
                ...
                * (
                    ...
                    -FSMRewardScales_3.track_object_l1 * track_object
    ...
    def compute_fsm_rewards(self):
        ...
        reward_case_0 = (
            ...
            -FSMRewardScales_0.track_object_l1 * track_object_l1(self, asset_cfg=SceneEntityCfg(name="robot"), object_cfg=SceneEntityCfg("object"))
            +FSMRewardScales_0.above_palm * above_palm(self)
        )
        reward_case_1 = (
            -FSMRewardScales_1.undesired_contacts * undesired_contacts(self, threshold=1e-5, sensor_cfg=SceneEntityCfg(name="sensor"))
            -FSMRewardScales_1.track_object_l1 * track_object_l1(self, asset_cfg=SceneEntityCfg(name="robot"), object_cfg=SceneEntityCfg("object"))
        ...
        reward_case_2 = (
            ...
            -FSMRewardScales_2.track_object_l1 * track_object_l1(self, asset_cfg=SceneEntityCfg(name="robot"), object_cfg=SceneEntityCfg("object"))
        ...
        reward_case_3 = (
            ...
            -FSMRewardScales_3.track_object_l1 * track_object_l1(self, asset_cfg=SceneEntityCfg(name="robot"), object_cfg=SceneEntityCfg("object"))
            ...
            -FSMRewardScales_3.body_undesired_contacts * undesired_contacts(self, threshold=1e-5, sensor_cfg=SceneEntityCfg(name="link6_sensor"))
        )
